...
if __name__ == "__main__":
  ...
  parser.add_argument('--playlist_url', type=str, default='https://www.youtube.com/playlist?list=PL8Kqpe3GkRgEgsXA39EE5lsArQPrcZcLj',
                      help='The YouTube playlist to get videos from (default: Kakashi WOD Playlist)')
